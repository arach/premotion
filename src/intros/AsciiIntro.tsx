...
const { fontFamily } = loadFont("normal", {
  weights: ["300"],  // Light weight for thinner look
  subsets: ["latin"],
});

// ASCII art split into ARACH, dot, and DEV for precise spacing control
const ARACH_ART = [
  "\u00A0█████╗ ██████╗  █████╗  ██████╗██╗  ██╗",
  "██╔══██╗██╔══██╗██╔══██╗██╔════╝██║  ██║",
  "███████║██████╔╝███████║██║     ███████║",
...
// Spacing between parts (in pixels)
const DOT_MARGIN_LEFT = 6;   // pixels before dot
const DOT_MARGIN_RIGHT = 4;  // pixels after dot

export const AsciiIntro: React.FC = () => {
  ...
  // Shimmer position - moves left to right across the ASCII art
  ...
  return (
    ...
    >
      ...
      {/* ASCII Art with shimmer - three parts with pixel spacing */}
      <div
        style={{
