// Studio loadout: logos & brand cards only.
// Use when iterating on motion logos, thumbnails, brand reveals.
//
...
export const LogosRoot: React.FC = () => (
	<>
		{/* Brand cards — static thumbnails / coming-soon scenes */}
		<Composition
			id="TalkieComingSoon"
		...
		{/* Motion logos — animated brand reveals */}
