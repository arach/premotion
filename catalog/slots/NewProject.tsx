  ...
  if (submitted) {
    return (
      <div className="flex flex-col items-center justify-center h-full gap-3">
        <div className="text-[14px] text-emerald-400/80 font-mono">Queued for processing</div>
        <div className="text-[11px] text-white/30 font-mono">Returning to catalog…</div>
      </div>
    );
  }
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="shrink-0 flex items-center gap-3 px-6 py-4 border-b border-white/[0.06]">
        ...
        <h1 className="text-[14px] font-medium text-white/90">New Project</h1>
      </div>
      ...
      <div className="flex-1 min-h-0 overflow-y-auto frame-scrollbar">
        <div className="max-w-2xl mx-auto px-6 py-8 flex flex-col gap-8">
          ...
          <div className="flex items-center gap-3">
            ...
            >
              <Send size={12} />
              {submitting ? 'Queueing…' : 'Queue Project'}
            </button>
            <button
